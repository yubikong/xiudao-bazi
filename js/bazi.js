...
7. 外遇归属与配偶条件（防归属判反、防细节判错）：
   - 适用范围铁律：外遇归属规则仅适用于题目明确问"分手原因/外遇/第三者/感情归属"或论"已婚者婚姻状态"之时；不得仅因日时柱带红艳/桃花即断"性格风流多情"，亦不得在婚姻/子女概况题（问是否离婚、有无子女）中优先用红艳断"自己有外遇"——此类题应优先断婚变/子女。红艳/桃花/咸池绝不得单独用于性格判断题：性格须以魁罡/七杀/比劫/枭印/食伤之旺衰与身强弱取象，红艳只作感情归属题辅助。红艳/桃花落自身柱仅主异性缘旺、追求者多，须配合官杀（女）/妻星（男）受制或日支被实质冲刑才断"自己有外遇"。
...
F. 命局层次与外观取象专项（学历/家境/体型/健康，防高估，实测必守）
