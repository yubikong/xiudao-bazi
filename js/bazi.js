...
(function () {
  ...
  $(function () {
    ...
    $('#bz-ai-btn').on('click', function () { clipCopy(bzAIGang(), this); });
    $('#bz-ai-zong-btn').on('click', function () { clipCopy(bzAITotal(), this); });
    $('#bz-ai-liu-btn').on('click', function () { clipCopy(bzAILiu(), this); });
    $('#bz-ai-xijie-btn').on('click', function () { clipCopy(bzAIXijie(), this); });
  });
